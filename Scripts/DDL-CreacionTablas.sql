...
--Se eliminan las secuencias despu�s
...
--Por �ltimo, se eliminan las tablas
...
CREATE TABLE LB.Item (ID INT PRIMARY KEY NOT NULL, 
                      ...
                      CreatedBy NCHAR(30),
                      UpdatedOn DATE,
                      UpdatedBy NCHAR(30)); --el on_loan nos permite saber cu�les y cu�ntos items est�n en pr�stamo
